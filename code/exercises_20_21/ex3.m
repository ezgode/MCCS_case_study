...
classdef ex3
    ...
    methods(Static)
        ...
        function varargout = getAllowedControlValues
            ...
            % returns a two-columns array U = [u_1,u_2] gathering all the 
            % combinations of control inputs that are considered to build 
        ...
        function varargout = getObstacle
            ...
            % returns two-column array [x,y], where every row i contains
            % the position [x_i,y_i] of obstacle i. 
            %
        ...
        function varargout = backtrackNodeValues( nodes, edges, node_cost, sampling_time)
            ...
            % considering the way you propagated the cost in the previous
            ...
            % built graph, have a flag = 0, which is stored in the third
            % column of the NODES array. 
